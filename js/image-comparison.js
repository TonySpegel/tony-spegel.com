...
`;const pt=(t,e,i)=>Math.min(Math.max(t,e),i);class vt extends rt{constructor(){super(...arguments),this.variant='slider',this.overlayPrompt='Tap and hold to compare',this.sliderPrompt='Move the slider to compare',this.sliderPosition=50,this.sliderSteps=5,this.slidingActive=!1,this.isRtl=!1,this.pressed=!1,this.slideCompareHandler=t=>{this.slideCompare(t)},this.slideEndHandler=()=>{this.setSlidingState(!1),window.dispatchEvent(new ht(this))},this.readingDirectionHandler=t=>{for(const e of t)if('dir'===e.attributeName){const{dir:t}=e.target;this.isRtl='rtl'===t}},this.keyboardOverlayHandler=t=>{const{key:e,code:i}=t;'Space'===i&&t.preventDefault(),'Space'!==i&&'Enter'!==e||(this.pressed=!0)},this.keyboardSliderHandler=t=>{const{code:e,key:i,ctrlKey:s,metaKey:r,shiftKey:o}=t,{isRtl:n}=this,l=!n,a=o?this.sliderSteps:1;let d=this.sliderPosition;'Space'!==e&&'Home'!==i&&'End'!==i||t.preventDefault(),('ArrowLeft'===i&&l||'ArrowRight'===i&&n)&&(t.preventDefault(),d-=a),('ArrowRight'===i&&l||'ArrowLeft'===i&&n)&&(t.preventDefault(),d+=a),('Home'===i||(r||s)&&'ArrowLeft'===i)&&(d=0),('End'===i||(r||s)&&'ArrowRight'===i)&&(d=100),'Enter'===i&&(d=50),this.sliderPosition=pt(d,0,100)}}setPressed(t){this.pressed=t,window.dispatchEvent(new ct(this,t))}convertCursorToSliderPosition(t){const{left:e,width:i}=this.imageContainer.getBoundingClientRect(),{scrollX:s}=window,r=t instanceof MouseEvent?t.pageX:t.changedTouches[0].pageX;return parseFloat(pt((r-(e+s))/i*100,0,100).toFixed(2))}slideCompare(t){if(this.slidingActive){let e=this.convertCursorToSliderPosition(t);e=this.isRtl?100-e:e,this.sliderPosition=e}}setSlidingState(t){this.slidingActive=t}addSliderEventListener(){'slider'===this.variant&&(window.addEventListener('mousemove',this.slideCompareHandler),window.addEventListener('touchmove',this.slideCompareHandler),window.addEventListener('mouseup',this.slideEndHandler),window.addEventListener('touchend',this.slideEndHandler))}removeSliderEventListener(){window.removeEventListener('mousemove',this.slideCompareHandler),window.removeEventListener('touchmove',this.slideCompareHandler),window.removeEventListener('mouseup',this.slideEndHandler),window.removeEventListener('touchend',this.slideEndHandler)}attributeChangedCallback(t='variant',e,i){super.attributeChangedCallback(t,e,i),'variant'===t&&i!==e&&'slider'===i&&this.addSliderEventListener(),'variant'===t&&i!==e&&'overlay'===i&&this.removeSliderEventListener()}connectedCallback(){var t;super.connectedCallback(),this.addSliderEventListener(),this.readingDirectionObserver=new MutationObserver(this.readingDirectionHandler),this.readingDirectionObserver.observe(null===(t=this.ownerDocument)||void 0===t?void 0:t.querySelector('html'),{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeSliderEventListener(),this.readingDirectionObserver.disconnect()}render(){const t=_`
      ...
      >
        ...
        <div
          id="container-after"
          style=${this.isRtl?`clip-path: inset(0 ${this.sliderPosition}% 0 0)`:`clip-path: inset(0 0 0 ${this.sliderPosition}%)`}
        >
        ...
        <button
          ...
          @keyup=${()=>this.setSlidingState(!1)}
          @mousedown=${()=>{this.setSlidingState(!0)}}
          @mousemove=${t=>this.slideCompareHandler(t)}
          @touchstart=${t=>{t.preventDefault(),this.setSlidingState(!0)}}
          @touchmove=${t=>this.slideCompareHandler(t)}
          @dblclick=${()=>{this.sliderPosition=50}}
          style="left: ${this.isRtl?-this.sliderPosition:this.sliderPosition}%"
    ...
    `,e=_`
      <div
        ...
        @keyup=${()=>{this.setPressed(!1)}}
        @mousedown=${()=>{this.setPressed(!0)}}
        @mouseup=${()=>{this.setPressed(!1)}}
        @mouseleave=${()=>{this.setPressed(!1)}}
        @touchstart=${t=>{t.preventDefault(),this.setPressed(!0)}}
        @touchend=${t=>{t.preventDefault(),this.setPressed(!1)}}
        tabindex="0"
    ...
    `;return _`
      ${((t,e,i)=>{for(const i of e)if(i[0]===t)return(0,i[1])();return null==i?void 0:i()})(this.variant,[['slider',()=>t],['overlay',()=>e],['split',()=>i]])}
    `}}vt.styles=ut,t([lt({type:String})],vt.prototype,'variant',void 0),t([lt({type:String})],vt.prototype,'overlayPrompt',void 0),t([lt({type:String})],vt.prototype,'sliderPrompt',void 0),t([lt({type:Number,reflect:!0})],vt.prototype,'sliderPosition',void 0),t([lt({type:Number})],vt.prototype,'sliderSteps',void 0),t([
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(t,e){return(({finisher:t,descriptor:e})=>(i,s)=>{var r;if(void 0===s){const s=null!==(r=i.originalKey)&&void 0!==r?r:i.key,o=null!=e?{kind:'method',placement:'prototype',key:s,descriptor:e(i.key)}:{...i,key:s};return null!=t&&(o.finisher=function(e){t(e,s)}),o}{const r=i.constructor;void 0!==e&&Object.defineProperty(i,s,e(s)),null==t||t(r,s)}})({descriptor:i=>{const s={get(){var e,i;return null!==(i=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t))&&void 0!==i?i:null},enumerable:!0,configurable:!0};if(e){const e='symbol'==typeof i?Symbol():'__'+i;s.get=function(){var i,s;return void 0===this[e]&&(this[e]=null!==(s=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(t))&&void 0!==s?s:null),this[e]}}return s}})}('#image-container')],vt.prototype,'imageContainer',void 0),t([at()],vt.prototype,'slidingActive',void 0),t([at()],vt.prototype,'isRtl',void 0),t([at()],vt.prototype,'pressed',void 0),window.customElements.define('image-comparison',vt);const mt=document.querySelector('#image-comparison-demo');document.querySelectorAll('input[name="variant"]').forEach((t=>t.addEventListener('change',(t=>{const{value:e}=t.target;mt.setAttribute('variant',e)}))));
